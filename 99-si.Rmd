...
- A tutorial for [LC-MS pre-processing with
  `xcms`](https://github.com/jorainer/metabolomics2018) with examples on how to
  perform centroiding of profile-mode MS data in `R` and how to define data
  set-specific parameters for chromatographic peak detection, alignment and
  correspondence of untargeted (LC-MS-based) metabolomics data.
